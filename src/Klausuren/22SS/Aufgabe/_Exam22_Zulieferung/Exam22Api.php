...
class Exam22Api extends Page
{
    ...
    protected function getViewData(): array
    {
        ...
        $sql = "SELECT * FROM Dictionary WHERE TRIM(LOWER(`word`)) = '$this->searchword'";
        $recordset = $this->_database->query($sql);
        $record = $recordset->fetch_assoc();
        //if the word exists, get the explanation
        if ($record) {
            $data["id"] = $record["id"];
            $data["word"] = $record["word"];
    ...
    protected function generateView(): void
    {
        ...
        //print the result as JSON and set the languange in Germany
